...
import corpusMethods, MultilitCorpusClasses
#import etree
...
for f in inputfilelist:
    #subprocess.call("sh ../taggerscript/tree-tagger-multi_german.sh "+f+" > "+f+".pos") #writes output to a file with suffix .pos
    os.system("sh ../taggerscript/tree-tagger-multi_english.sh " + f + " > " + tmpdir + "/" + f + ".pos")
...
for tupel in corpusmatches:
    tupel[0].eltree.write('testoutputEnglish/' + tupel[0].filename + '_pos.exb')
